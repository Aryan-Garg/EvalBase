...
class CustomDataset(Dataset):
    def __init__(self, path_pred: str, path_gt: str, image_transform, load2RAM=False):
...
def get_data_loaders(path_pred, path_gt, batch_size):
    ...
    if batch_size:
        dataloader = DataLoader(
            CustomDataset(path_pred=path_pred, path_gt=path_gt, image_transform=tensor_transform),
